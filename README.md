...
Proyek ini dibuat untuk memenuhi syarat kelulusan Skripsi
oleh Jessica Ho - 535220187
...
1. Memastikan Python sudah terpasang
2. Clone Repository ini
3. Masuk ke folder projek
4. Buat virtual environment (Windows)
   ```bash
   python -m venv venv
...
### Manual Penggunaan Website
Panduan penggunaan website dapat diakses melalui link berikut.
